...
class ElasticTransform {
    static createShouldClauses({ parsedText }) {
        return _.flow([
            _.toPairs,
            _.map(([key, value]) => {
                var _a;
    ...
    static createQuery({ layer, parsedText }) {
        const result = {
            bool: {
                must: [],
    ...
    static async createSearchBody({ text, size, lat, lon, countFunc, geocode = false, multiIndexOpts = null, }) {
